...
public class TicketMasterAPI {
    private static final String URL_PREFIX = "https://app.ticketmaster.com/discovery/v2/events.json";
    private static final String DEFAULT_KEYWORD = "";
    private static final String API_KEY = "Ku1fcxjKUrWU1m6jnGQ7U16FwkYH8b1U";
    ...
    public List<Item> search(double lat, double lon, String keyword) {
        ...
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(URL_PREFIX + "?" + query).openConnection();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ticketMasterAPI.search(37.38, -122.08, null));
    }
